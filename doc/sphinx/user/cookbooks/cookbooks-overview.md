...
-   What internal forces act on the medium (the left-hand side equation)?

-   What external forces act on the medim (the right-hand side of the equation)?
...
geometry (a &ldquo;box&rdquo;) with the edge length ("extnet)") equal to one in both the $x$-
